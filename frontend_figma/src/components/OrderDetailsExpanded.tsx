...
export default function OrderDetailsExpanded({ item, isProgressExpanded = false, onToggleProgress }: OrderDetailsExpandedProps) {
  ...
  // For Products - Simple Details
  return (
    <div className="bg-[#f6f7f9] rounded-[15px] p-[24px] mt-4 mx-[10px] mb-[10px]">
      <h3 className="font-['Work_Sans:Bold',sans-serif] font-bold text-[18px] text-[#2963a3] mb-4">
        Order Details
      </h3>
      <div className="space-y-3">
        <div className="flex justify-between">
          <span className="font-['Work_Sans:Medium',sans-serif] font-medium text-[14px] text-[#64748b]">
            Product:
          </span>
          <span className="font-['Work_Sans:SemiBold',sans-serif] font-semibold text-[14px] text-[#2963a3]">
            {item.title}
          </span>
        </div>
        <div className="flex justify-between">
          ...
          <span className="font-['Work_Sans:SemiBold',sans-serif] font-semibold text-[14px] text-[#2963a3] font-mono">
            {item.orderNumber}
          </span>
        </div>
        <div className="flex justify-between">
        ...
        <div className="flex justify-between pt-3 border-t border-[#e2e8f0]">
          ...
          <span className="font-['Work_Sans:Bold',sans-serif] font-bold text-[16px] text-[#2963a3]">
            ₱{(item.price * (item.quantity || 1)).toLocaleString()}.00
          </span>
        </div>
      </div>
    </div>
