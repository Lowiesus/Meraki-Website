import svgPaths from "./svg-91ltctvwp6";
...
export default function CartAndOrdersCodUi() {
  return (
    <div className="bg-white relative size-full" data-name="CART AND ORDERS_COD-UI">
      <Frame14 />
      <Frame21 />
      <Frame20 />
      <Frame3 />
