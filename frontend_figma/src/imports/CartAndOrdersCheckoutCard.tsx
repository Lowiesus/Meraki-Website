import svgPaths from "./svg-uaeb1pr0y4";
...
function AutoLayoutHorizontal() {
  return (
    <div className="box-border content-stretch flex items-start pb-[14.857px] pl-[27.875px] pr-[26.643px] pt-[13.714px] relative shrink-0" data-name="Auto Layout Horizontal">
      ...
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#2963a3] text-[14.857px] text-center uppercase w-[94px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[20.571px]">commisions</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-white h-[100px] relative rounded-[15px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[100px] items-center justify-between px-[10px] py-[9px] relative w-full">
          ...
          <p className="capitalize font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#1f4d7c] text-[15px] text-center w-[202px]">Pre-made VTuber Models</p>
          <Frame26 />
          <Group4 />
...
function Frame21() {
  return (
    <div className="box-border content-stretch flex items-center justify-center leading-[normal] px-[10px] py-0 relative shrink-0 text-[#36963c] w-[231px]">
      <p className="font-['Work_Sans:Medium',sans-serif] font-medium relative shrink-0 text-[12px] w-[77px]">{`USERNAME `}</p>
      <p className="font-['Work_Sans:Medium',sans-serif] font-medium relative shrink-0 text-[12px] w-[9px]">|</p>
      <p className="font-['Work_Sans:Italic',sans-serif] font-normal italic relative shrink-0 text-[8.5px] w-[79px]">@username</p>
    </div>
...
function Frame27() {
  return (
    <div className="box-border content-stretch flex flex-col items-center justify-center pb-[5px] pt-0 px-0 relative shrink-0 text-[12px] text-center">
      <p className="font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[20px] leading-none relative shrink-0 text-white w-[72px]">STATUS:</p>
      <div className="font-['Work_Sans:Regular',sans-serif] font-normal leading-none mb-[-5px] relative shrink-0 text-[#f6f7f9] w-[72px]">
...
function Group5() {
  return (
    <div className="h-[8.571px] relative shrink-0 w-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 9">
        <g id="Group 6">
          <path d="M20 0L10 8.57143L0 0H20Z" fill="var(--fill-0, white)" id="Rectangle 7" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="bg-[#428dfe] h-[100px] relative rounded-[15px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[100px] items-center justify-between px-[10px] py-[9px] relative w-full">
          <Frame23 />
          <div className="bg-[red] h-[82.286px] rounded-[8px] shrink-0 w-[80px]" />
          <p className="capitalize font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[15px] text-center text-white w-[202px]">digital Anime Illustration</p>
          <Frame27 />
          <Group5 />
          <p className="font-['Work_Sans:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-center text-white w-[107px]">₱1,000.00</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-white h-[100px] relative rounded-[15px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[100px] items-center justify-between px-[10px] py-[9px] relative w-full">
          <Frame40 />
          <div className="bg-[red] h-[82.286px] rounded-[8px] shrink-0 w-[80px]" />
          <p className="capitalize font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#1f4d7c] text-[15px] text-center w-[202px]">website Design</p>
          <Frame41 />
          <Group7 />
...
function Frame44() {
  return (
    <div className="box-border content-stretch flex items-center justify-center leading-[normal] px-[10px] py-0 relative shrink-0 text-[rgba(30,30,30,0.35)] w-[231px]">
      <p className="font-['Work_Sans:Medium',sans-serif] font-medium relative shrink-0 text-[12px] w-[77px]">{`USERNAME `}</p>
      <p className="font-['Work_Sans:Medium',sans-serif] font-medium relative shrink-0 text-[12px] w-[9px]">|</p>
      <p className="font-['Work_Sans:Italic',sans-serif] font-normal italic relative shrink-0 text-[8.5px] w-[79px]">@username</p>
    </div>
    ...
    <div className="bg-[#e4e4e4] h-[100px] relative rounded-[15px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[100px] items-center justify-between px-[10px] py-[9px] relative w-full">
          <Frame45 />
          <div className="bg-[red] h-[82.286px] rounded-[8px] shrink-0 w-[80px]" />
          <p className="capitalize font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#1f4d7c] text-[15px] text-center w-[202px]">Anime Illustration</p>
          <Frame46 />
          <Group8 />
...
function CardTypes() {
  return (
    <div className="content-stretch flex gap-[18px] items-center relative shrink-0 w-full" data-name="CARD TYPES">
      ...
      <div className="h-[57.967px] relative rounded-[5.27px] shrink-0 w-[79.045px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[5.27px]">
          <div className="absolute bg-[rgba(251,206,122,0.35)] inset-0 rounded-[5.27px]" />
...
function Frame36() {
  return (
    <div className="content-stretch flex items-center opacity-50 relative shrink-0 w-[106.25px]">
      <Frame37 />
...
function Name() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-full" data-name="NAME">
      ...
      <p className="absolute font-['Work_Sans:Medium',sans-serif] font-medium h-[19px] leading-[normal] left-[18.77px] text-[#2963a3] text-[12.647px] top-[38.84px] w-[334px]">FIRST NAME LAST NAME</p>
    </div>
  );
}
...
function CardNumber() {
  return (
    <div className="h-[67.451px] relative shrink-0 w-full" data-name="CARD NUMBER">
      ...
      <p className="absolute font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] left-[18.97px] text-[#2963a3] text-[12.647px] top-[36.89px] w-[181.277px]">1111 2222 3333 4444</p>
    </div>
  );
}
...
function Expiration() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[180.224px]" data-name="EXPIRATION">
      ...
      <div className="bg-[#f6f7f9] h-[42.158px] rounded-[6.324px] shrink-0 w-full" />
      <p className="absolute font-['Work_Sans:Medium',sans-serif] font-medium h-[19px] leading-[normal] left-[18.97px] text-[#2963a3] text-[12.647px] top-[37.94px] w-[72.722px]">11/2030</p>
    </div>
  );
}
...
function Cvv() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[180.224px]" data-name="CVV">
      ...
      <div className="bg-[#f6f7f9] h-[42.158px] rounded-[6.324px] shrink-0 w-full" />
      <p className="absolute font-['Work_Sans:Medium',sans-serif] font-medium h-[19px] leading-[normal] left-[18.97px] text-[#2963a3] text-[12.647px] top-[37.94px] w-[72.722px]">123</p>
    </div>
  );
}
...
function Subtotal() {
  return (
    <div className="content-stretch flex items-start justify-between leading-[normal] relative shrink-0 text-[#2963a3] w-full" data-name="SUBTOTAL">
      ...
      <p className="font-['Work_Sans:SemiBold',sans-serif] font-semibold relative shrink-0 text-[14px] text-right w-[145.444px]">₱2,000.00</p>
    </div>
  );
}
...
function Shipping() {
  return (
    <div className="content-stretch flex items-start justify-between leading-[normal] relative shrink-0 text-[#2963a3] w-full" data-name="SHIPPING">
      ...
      <p className="font-['Work_Sans:SemiBold',sans-serif] font-semibold relative shrink-0 text-[14px] text-right w-[145.444px]">₱0.00</p>
    </div>
  );
}
...
function Total() {
  return (
    <div className="content-stretch flex font-['Work_Sans:SemiBold',sans-serif] font-semibold items-start justify-between leading-[normal] relative shrink-0 text-[#2963a3] w-full" data-name="TOTAL">
      <p className="relative shrink-0 text-[14.755px] w-[145.444px]">TOTAL PAYMENT</p>
      <p className="relative shrink-0 text-[14px] text-right w-[145.444px]">₱2,000.00</p>
    </div>
  );
}
...
function CheckoutBtn() {
  return (
    <div className="bg-[#fbce7a] box-border content-stretch flex font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[63.236px] items-center justify-between leading-[normal] px-[25px] py-[19px] relative rounded-[25px] shrink-0 text-[#2963a3] w-[370.542px]" data-name="CHECKOUT BTN">
      <p className="relative shrink-0 text-[14px] w-[145.444px]">₱2,000.00</p>
...
export default function CartAndOrdersCheckoutCard() {
  return (
    <div className="bg-white relative size-full" data-name="CART AND ORDERS_CHECKOUT-CARD">
      <Frame13 />
      <Frame25 />
      <Frame51 />
      <Frame3 />
