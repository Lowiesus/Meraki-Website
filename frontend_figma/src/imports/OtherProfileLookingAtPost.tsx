import svgPaths from "./svg-on9eoufyqv";
...
import imgFrame from "figma:asset/0749a98062a8c3a00ce9c69c0494ab1c6d768145.png";
...
function Frame44() {
  return (
    <div className="absolute left-1/2 size-[16px] top-0 translate-x-[-50%]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Frame">
          <path d={svgPaths.p3ed758c0} fill="var(--fill-0, black)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame52() {
  return (
    <div className="h-[591px] overflow-clip relative shrink-0 w-[411px]" data-name="Frame">
      <Frame51 />
    </div>
  );
}
...
function AutoLayoutHorizontal33() {
  return (
    <div className="bg-[#efefef] content-stretch flex h-[591px] items-start relative shrink-0" data-name="Auto Layout Horizontal">
      <Frame52 />
    </div>
  );
}
...
function AutoLayoutHorizontal34() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.8)] box-border content-stretch flex inset-[555px_373px_8px_10px] items-start p-[8px] rounded-[20px]" data-name="Auto Layout Horizontal">
      <Frame54 />
    </div>
  );
}
...
function AutoLayoutHorizontal36() {
  return (
    <div className="absolute content-stretch flex h-[591px] items-start left-[0.01px] overflow-clip top-[calc(50%-0.49px)] translate-y-[-50%]" data-name="Auto Layout Horizontal">
...
function Frame55() {
  return (
    <div className="h-[591px] relative shrink-0 w-[411px]" data-name="Frame">
      <AutoLayoutHorizontal36 />
      <div className="absolute left-[371.01px] size-[30px] top-[265.51px]" data-name="Image">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Frame56() {
  return (
    <div className="absolute inset-[562.51px_5.99px_0.49px_6.01px]" data-name="Frame">
      <div className="absolute bg-white left-[calc(50%-9.89px)] rounded-[3px] size-[6px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Rectangle" />
      <div className="absolute bg-white left-[calc(50%+0.11px)] opacity-40 rounded-[3px] size-[6px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Rectangle" />
      <div className="absolute bg-white left-[calc(50%+10.11px)] opacity-40 rounded-[3px] size-[6px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Rectangle" />
    </div>
  );
}
...
function AutoLayoutHorizontal38() {
  return (
    <div className="bg-[#0a1015] box-border content-stretch flex h-[672px] items-start overflow-clip px-0 py-[27.5px] relative shrink-0" data-name="Auto Layout Horizontal">
...
function Frame99() {
  return <div className="absolute left-[calc(50%+223.5px)] size-[24px] top-[calc(50%-1px)] translate-x-[-50%] translate-y-[-50%]" data-name="Frame" />;
}
...
function AutoLayoutHorizontal59() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] content-stretch flex items-start left-1/2 overflow-clip rounded-[4px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Auto Layout Horizontal">
...
function Frame110() {
  return (
    <div className="absolute h-[567.984px] left-[calc(50%-0.5px)] top-[calc(50%-20.01px)] translate-x-[-50%] translate-y-[-50%] w-[1349px]" data-name="Frame">
      <Frame50 />
...
export default function OtherProfileLookingAtPost() {
  return (
    <div className="bg-white relative size-full" data-name="OTHER PROFILE_LOOKING-AT-POST">
