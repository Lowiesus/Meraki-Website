import svgPaths from "./svg-uhiei6v10y";
...
function Frame10() {
  return (
    <div className="bg-[#f6f7f9] h-[350px] relative rounded-[15px] shrink-0 w-full" data-name="Frame">
      <div className="h-[350px] overflow-clip relative rounded-[inherit] w-full">
        <Frame9 />
      </div>
...
export default function CartAndOrdersOrderDetailsShortened() {
  return (
    <div className="bg-white relative size-full" data-name="CART AND ORDERS_ORDER-DETAILS_SHORTENED">
      <Frame22 />
      <Frame34 />
      <Frame31 />
      <Frame12 />
