import svgPaths from "./svg-m8dq3qxxuz";
...
function ExploreBtn() {
  return (
    <div 
      className="bg-[#428dfe] box-border content-stretch flex gap-[3.473px] h-[19px] items-start justify-center px-[3.473px] py-[4.515px] relative rounded-[20.838px] shrink-0 w-[60px] cursor-pointer hover:bg-[#5299ff] active:scale-95 transition-all" 
      data-name="Explore Btn"
      onClick={() => {
    ...
    <div className="border-[#8ebbff] border-[3px] border-solid relative size-full" data-name="Right_Panel">
      ...
      <div className="absolute flex items-center justify-center left-[-91px] size-[685.835px] top-[616px]" style={{ "--transform-inner-width": "625", "--transform-inner-height": "625" } as React.CSSProperties}>
        <div className="flex-none rotate-[354.11deg]">
          <div className="relative size-[504px] -translate-y-[100px]" data-name="QUESTION_PENGU 1">
