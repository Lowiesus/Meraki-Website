import svgPaths from "./svg-29muiv8n4g";
...
function Frame54() {
  return (
    <div className="absolute left-1/2 size-[24px] top-0 translate-x-[-50%]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Frame">
          <path d={svgPaths.p201bf680} id="Vector" stroke="var(--stroke-0, #80C1D3)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M6.545 12.001H17.455" id="Line" stroke="var(--stroke-0, #80C1D3)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M12.003 6.545V17.455" id="Line_2" stroke="var(--stroke-0, #80C1D3)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function AutoLayoutHorizontal56() {
  return (
    <div className="box-border content-stretch flex items-start overflow-clip pl-0 pr-[1.766px] py-0 relative shrink-0" data-name="Auto Layout Horizontal">
      <div className="flex flex-col font-['Work_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#80c1d3] text-[15px] text-nowrap">
...
function AutoLayoutHorizontal62() {
  return (
    <div className="box-border content-stretch flex items-start overflow-clip pl-[162.313px] pr-[162.688px] py-0 relative shrink-0" data-name="Auto Layout Horizontal">
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[16px] text-center text-neutral-800 text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[24px] whitespace-pre">Create new post</p>
      </div>
    </div>
  );
}
...
function Frame60() {
  return (
    <div className="absolute h-[77px] left-1/2 top-0 translate-x-[-50%] w-[96px]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 96 77">
        <g id="Frame">
          <path d={svgPaths.p2805900} fill="var(--fill-0, #262626)" id="Vector" />
          <path d={svgPaths.p1fc92480} fill="var(--fill-0, #262626)" id="Vector_2" />
          <path d={svgPaths.p37341000} fill="var(--fill-0, #262626)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function Frame61() {
  return (
    <div className="absolute h-[77px] left-1/2 overflow-clip top-[calc(50%-47.5px)] translate-x-[-50%] translate-y-[-50%] w-[96px]" data-name="Frame">
      <Frame60 />
    </div>
  );
}
...
function AutoLayoutHorizontal64() {
  return (
    <div className="absolute bg-[#0095f6] box-border content-stretch flex items-start left-[136.16px] pl-[16px] pr-[16.688px] py-[7px] rounded-[8px] top-[248.5px]" data-name="Auto Layout Horizontal">
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[14px] text-center text-nowrap text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[18px] whitespace-pre">Select from computer</p>
      </div>
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="absolute h-[397px] left-1/2 top-[calc(50%+21.5px)] translate-x-[-50%] translate-y-[-50%] w-[442px]" data-name="Frame">
      <Frame61 />
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[27px] justify-center leading-[0] left-[221.09px] text-[20px] text-center text-neutral-800 top-[214px] translate-x-[-50%] translate-y-[-50%] w-[256.153px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[25px]">Drag photos and videos here</p>
      </div>
...
function Frame63() {
  return (
    <div className="h-[440px] overflow-clip relative shrink-0 w-[442px]" data-name="Frame">
...
function AutoLayoutHorizontal65() {
  return (
    <div className="bg-white content-stretch flex items-start overflow-clip relative rounded-[12px] shrink-0" data-name="Auto Layout Horizontal">
      <Frame63 />
    </div>
  );
}
...
function AutoLayoutHorizontal66() {
  return (
    <div className="absolute box-border content-stretch flex items-start left-[calc(62.5%-33px)] overflow-clip p-[20px] top-[236px] translate-x-[-50%]" data-name="Auto Layout Horizontal">
...
export default function CreatePost() {
  return (
    <div className="bg-white relative size-full" data-name="CREATE POST">
      <Frame41 />
      <RightPanel />
