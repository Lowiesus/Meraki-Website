import svgPaths from "./svg-cwsfvvjuc0";
...
function AutoLayoutHorizontal() {
  return (
    <div className="box-border content-stretch flex items-start pb-[14.857px] pl-[27.875px] pr-[26.643px] pt-[13.714px] relative shrink-0" data-name="Auto Layout Horizontal">
      ...
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#2963a3] text-[14.857px] text-center uppercase w-[105px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Group5() {
  return (
    <div className="h-[8.571px] relative w-[20px]">
  ...
  return (
    <div className="content-stretch flex flex-col h-[20px] items-start justify-center leading-[0] relative shrink-0 text-[14px]" data-name="Frame">
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[#2d6eb7] text-nowrap whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        ...
        <span>{` has sent the `}</span>
        <span className="font-['Roboto:Medium',sans-serif] font-medium" style={{ fontVariationSettings: "'wdth' 100" }}>{`COMMISSION BREAKDOWN DETAILS               `}</span>
  ...
  return (
    <div className="content-stretch flex flex-col h-[20px] items-start justify-center relative shrink-0 text-[14px]" data-name="Frame">
      <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[18px] relative shrink-0 text-[#2d6eb7] text-nowrap whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        [MERAKI SYSTEM] COMMISION AWAITING INITAL PAYMENT
      </p>
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col h-[20px] items-start justify-center relative shrink-0 text-[14px]" data-name="Frame">
      <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[18px] relative shrink-0 text-[#2d6eb7] text-nowrap whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        [MERAKI SYSTEM] INITAL PAYMENT SUCCESSFULLY PAID
      </p>
      <div className="flex flex-col font-['Roboto:Light',sans-serif] font-light justify-center leading-[0] relative shrink-0 text-[#a9b7d9] w-[395px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[18px]">
          <span>{`12:25 PM | `}</span>
  ...
  return (
    <div className="content-stretch flex flex-col h-[20px] items-start justify-center leading-[0] relative shrink-0 text-[14px]" data-name="Frame">
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[#2d6eb7] text-nowrap whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        ...
        <span>{` has started working on the commission`}</span>
      </p>
      <div className="flex flex-col font-['Roboto:Light',sans-serif] font-light justify-center relative shrink-0 text-[#a9b7d9] w-[395px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[18px]">
          <span>{`12:45 PM | `}</span>
...
function Frame42() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-[724px]">
      <Frame43 />
      <Frame39 />
      <Frame26 />
    </div>
...
function Frame49() {
  return (
    <div className="h-[22px] relative shrink-0 w-[51px]">
      <div className="absolute bg-white border border-[#949494] border-solid h-[22px] left-[calc(50%-0.5px)] rounded-[4px] top-0 translate-x-[-50%] w-[24px]" />
    </div>
  );
}
...
function Frame52() {
  return (
    <div className="box-border content-stretch flex flex-col items-center justify-center pb-[5px] pt-0 px-0 relative shrink-0 text-[12px] text-center">
      ...
      <div className="font-['Work_Sans:Regular',sans-serif] font-normal leading-none mb-[-5px] relative shrink-0 text-[#a6a6a6] w-[72px]">
    ...
    <div className="bg-white h-[100px] relative rounded-[15px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[100px] items-center justify-between px-[10px] py-[9px] relative w-full">
          <Frame49 />
          <div className="bg-[red] h-[82.286px] rounded-[8px] shrink-0 w-[80px]" />
          <p className="capitalize font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[15px] text-[red] text-center w-[202px]">Digital Anime Illustration</p>
          <Frame52 />
          <Group6 />
...
function Frame70() {
  return (
    <div className="box-border content-stretch flex flex-col items-center justify-center pb-[5px] pt-0 px-0 relative shrink-0 text-[12px] text-center">
      <p className="font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[20px] leading-none relative shrink-0 text-[#104274] w-[72px]">STATUS:</p>
      <div className="font-['Work_Sans:Regular',sans-serif] font-normal h-[20px] leading-none mb-[-5px] relative shrink-0 text-[#a6a6a6] w-[72px]">
    ...
    <div className="bg-white h-[100px] relative rounded-[15px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[100px] items-center justify-between px-[10px] py-[9px] relative w-full">
          <Frame69 />
          <div className="bg-[red] h-[82.286px] rounded-[8px] shrink-0 w-[80px]" />
          <p className="capitalize font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[15px] text-[red] text-center w-[202px]">website Design</p>
          <Frame70 />
          <Group8 />
    ...
    <div className="bg-[#e4e4e4] h-[100px] relative rounded-[15px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[100px] items-center justify-between px-[10px] py-[9px] relative w-full">
          <Frame74 />
          <div className="bg-[red] h-[82.286px] rounded-[8px] shrink-0 w-[80px]" />
          <p className="capitalize font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[15px] text-[red] text-center w-[202px]">Anime Illustration</p>
          <Frame75 />
          <Group9 />
...
export default function CartAndOrdersOrderDetails() {
  return (
    <div className="bg-white relative size-full" data-name="CART AND ORDERS_ORDER-DETAILS">
      <Frame38 />
      <Frame50 />
      <Frame47 />
      <Frame28 />
