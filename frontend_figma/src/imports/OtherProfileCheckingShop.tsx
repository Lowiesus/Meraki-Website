import svgPaths from "./svg-hyap9jlwnr";
...
function Frame44() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4.78px] items-start right-[7.17px] top-[7.17px]">
      <div className="relative shrink-0 size-[12.138px]" data-name="Fill Heart">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 21">
          <circle cx="10.1575" cy="10.1575" fill="var(--fill-0, white)" id="Ellipse 13" r="10.1575" />
        </svg>
        <div className="absolute inset-[14.71%] overflow-clip" data-name="heart small">
          <div className="absolute inset-[20.83%_16.67%]" data-name="Vector">
            <div className="absolute inset-[-5.36%_-4.69%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 10">
                <path d={svgPaths.pdb113b0} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.896252" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="relative shrink-0 size-[12.138px]" data-name="Fill Eye">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 21">
          <circle cx="10.1575" cy="10.1575" fill="var(--fill-0, white)" id="Ellipse 13" r="10.1575" />
        </svg>
        <div className="absolute inset-[14.71%] overflow-clip" data-name="Quick View">
...
function Frame46() {
  return (
    <div className="content-stretch flex gap-[4.78px] items-start relative shrink-0">
      <div className="content-stretch flex items-start relative shrink-0" data-name="Four Star">
        <div className="relative shrink-0 size-[11.95px]" data-name="Vector">
          <div className="absolute inset-[16.7%_13.84%_11.82%_13.63%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
              <path d={svgPaths.pe69b280} fill="var(--fill-0, #FFAD33)" id="Vector" />
            </svg>
          </div>
        </div>
        <div className="relative shrink-0 size-[11.95px]" data-name="Vector">
        ...
        <div className="relative shrink-0 size-[11.95px]" data-name="Vector">
          <div className="absolute inset-[16.7%_13.84%_11.82%_13.63%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
              <path d={svgPaths.pe69b280} fill="var(--fill-0, black)" id="Vector" opacity="0.25" />
            </svg>
          </div>
        </div>
      </div>
...
function Frame73() {
  return (
    <div className="bg-[#104274] box-border content-stretch flex gap-[8px] items-center justify-center px-[28.68px] py-[9.56px] relative rounded-[8px] shrink-0">
...
export default function OtherProfileCheckingShop() {
  return (
    <div className="bg-white relative size-full" data-name="OTHER PROFILE_CHECKING-SHOP">
