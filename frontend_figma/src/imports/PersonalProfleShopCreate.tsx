import svgPaths from "./svg-rs3uyu89nj";
...
function AutoLayoutHorizontal62() {
  return (
    <div className="box-border content-stretch flex items-start overflow-clip pl-[162.313px] pr-[162.688px] py-0 relative shrink-0" data-name="Auto Layout Horizontal">
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[16px] text-center text-neutral-800 w-[528px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[24px]">Edit Shop</p>
      </div>
    </div>
  );
}
...
function AutoLayoutHorizontal64() {
  return (
    <div className="absolute bg-[#0095f6] box-border content-stretch flex items-start left-[728px] pl-[16px] pr-[16.688px] py-[7px] rounded-[8px] top-[656px]" data-name="Auto Layout Horizontal">
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[14px] text-center text-nowrap text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[18px] whitespace-pre">Create</p>
      </div>
    </div>
  );
}
...
function AutoLayoutHorizontal65() {
  return (
    <div className="absolute bg-[#0095f6] box-border content-stretch flex items-start left-[700px] pl-[16px] pr-[16.688px] py-[7px] rounded-[8px] top-[283px]" data-name="Auto Layout Horizontal">
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[14px] text-center text-nowrap text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[18px] whitespace-pre">Add Tags +</p>
      </div>
    </div>
  );
}
...
function AutoLayoutHorizontal66() {
  return (
    <div className="absolute bg-[#b7dbfa] box-border content-stretch flex items-start left-[638px] pl-[16px] pr-[16.688px] py-[7px] rounded-[8px] top-[656px]" data-name="Auto Layout Horizontal">
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[14px] text-center text-nowrap text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function RoleAndIcon() {
  return (
    <div className="absolute bg-[#f6f7f9] box-border content-stretch flex items-center justify-between left-[425px] p-[16px] rounded-[8px] top-[206px] w-[378px]" data-name="Role and icon">
      <p className="font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#2963a3] text-[14px] text-nowrap whitespace-pre">Type</p>
...
function Frame60() {
  return (
    <div className="h-[709px] overflow-clip relative shrink-0 w-[849px]" data-name="Frame">
...
function AutoLayoutHorizontal67() {
  return (
    <div className="bg-white content-stretch flex h-[709px] items-start overflow-clip relative rounded-[12px] shrink-0 w-[849px]" data-name="Auto Layout Horizontal">
      <Frame60 />
    </div>
  );
}
...
function AutoLayoutHorizontal68() {
  return (
    <div className="absolute box-border content-stretch flex h-[749px] items-start left-[calc(58.33%-7.5px)] overflow-clip p-[20px] top-[130px] translate-x-[-50%] w-[889px]" data-name="Auto Layout Horizontal">
  ...
  return (
    <div className="absolute inset-[15.62%_11.46%_16.39%_11.46%]" data-name="Camera">
      <div className="absolute inset-[-6.89%_-6.08%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 18">
          <g id="Camera">
            <path clipRule="evenodd" d={svgPaths.p3759d500} fillRule="evenodd" id="Stroke 1" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.10865" />
            <path d="M14.8733 6.4433H14.8818" id="Stroke 13" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.81154" />
            <path clipRule="evenodd" d={svgPaths.pec51600} fillRule="evenodd" id="Stroke 5" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.10865" />
          </g>
        </svg>
      </div>
    </div>
...
function IconlyLightCamera() {
  return (
    <div className="relative shrink-0 size-[22.492px]" data-name="Iconly/Light/Camera">
      <Camera />
    </div>
  );
}
...
function Camera1() {
  return (
    <div className="absolute bg-[#ffd968] box-border content-stretch flex gap-[14.058px] items-start left-[273px] p-[11.246px] rounded-[126.519px] size-[43px] top-[258px]" data-name="Camera">
      <div aria-hidden="true" className="absolute border-[4.217px] border-solid border-white inset-[-2.108px] pointer-events-none rounded-[128.627px]" />
      <IconlyLightCamera />
    </div>
  );
}
...
function Frame61() {
  return (
    <div className="absolute bg-[red] h-[315px] left-[calc(25%+92px)] overflow-clip rounded-[8px] top-[322px] w-[330px]">
...
function IconlyLightProfile() {
  return <div className="shrink-0 size-[16px]" data-name="Iconly/Light/Profile" />;
}

function UsernameAndIcon() {
  return (
    <div className="absolute bg-[#f6f7f9] box-border content-stretch flex items-center justify-between left-[calc(58.33%-6px)] p-[16px] rounded-[8px] top-[290px] w-[378px]" data-name="Username and icon">
      <p className="font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#2963a3] text-[14px] text-nowrap whitespace-pre">Product Name</p>
      <IconlyLightProfile />
    </div>
  );
}
...
function UsernameAndIcon1() {
  return (
    <div className="absolute bg-[#f6f7f9] box-border content-stretch flex items-center justify-between left-[calc(58.33%-7px)] p-[16px] rounded-[8px] top-[426px] w-[250px]" data-name="Username and icon">
      <p className="font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#2963a3] text-[14px] text-nowrap whitespace-pre">Price</p>
      <IconlyLightProfile1 />
    </div>
  );
}

function UsernameAndIcon2() {
  return (
    <div className="absolute bg-[#f6f7f9] h-[170px] left-[calc(58.33%-7px)] rounded-[8px] top-[492px] w-[379px]" data-name="Username and icon">
      <p className="absolute font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] left-[14px] text-[#2963a3] text-[14px] text-nowrap top-[12px] whitespace-pre">Description</p>
    </div>
  );
}

export default function PersonalProfleShopCreate() {
  return (
    <div className="bg-white relative size-full" data-name="PERSONAL PROFLE_SHOP-CREATE">
      <Frame41 />
      <RightPanel />
      ...
      <Frame61 />
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[25.887px] left-[calc(58.33%-6px)] not-italic text-[#104274] text-[19.415px] text-nowrap top-[239px] tracking-[0.7766px] whitespace-pre">Product Details</p>
      <UsernameAndIcon />
      <UsernameAndIcon1 />
      <UsernameAndIcon2 />
    </div>
