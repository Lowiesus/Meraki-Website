import svgPaths from "./svg-snf8g6z91f";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex items-center left-0 top-0 w-[149px]" data-name="Frame">
      ...
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] opacity-30 relative shrink-0 text-[#2963a3] text-[14.857px] text-center uppercase w-[130px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[20.571px]">COMPLETED</p>
      </div>
    </div>
  );
}
...
function Frame54() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[128.35px]">
      <Frame53 />
      <p className="font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[16.15px] leading-[normal] relative shrink-0 text-[#36963c] text-[10.2px] w-[104.55px]">Pay Via Dragonpay</p>
    </div>
  );
}
...
function CheckoutBtn() {
  return (
    <div className="bg-[#fbce7a] box-border content-stretch flex font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[63.236px] items-center leading-[normal] pl-[25px] pr-[35px] py-[19px] relative rounded-[25px] shrink-0 text-[#2963a3] w-[370.542px]" data-name="CHECKOUT BTN">
      <p className="mr-[-10px] relative shrink-0 text-[14px] w-[145.444px]">₱</p>
      <p className="mr-[-10px] relative shrink-0 text-[15px] w-[202px]">CONTINUE TO DRAGONPAY</p>
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="absolute bg-[rgba(254,255,243,0.5)] h-[377px] left-[10px] rounded-[21.079px] top-[21px] w-[409px]">
      <Frame38 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center relative shrink-0 w-full">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-full not-italic relative shrink-0 text-[#104274] text-[22px] text-center w-[min-content]">Payment Succes!</p>
      <p className="font-['Work_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#bec3cd] text-[15px] text-center w-[300px]">Payment successful — your transaction has been processed and confirmed.</p>
      <Group9 />
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="bg-[#428dfe] box-border content-stretch flex flex-col gap-[10px] h-[72px] items-center justify-center px-[39px] py-[22px] relative rounded-[50px] shadow-[0px_9px_14px_0px_rgba(255,141,77,0.2)] shrink-0 w-[367px]">
      <p className="font-['Poppins:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] text-center text-white w-[183px]">CONFIRM PAYMENT</p>
    </div>
  );
}
...
export default function CartAndOrdersDragonpayUiConfirm() {
  return (
    <div className="bg-white relative size-full" data-name="CART AND ORDERS_DRAGONPAY_UI_CONFIRM">
      <Frame17 />
      <Frame29 />
      <Frame26 />
      <Frame5 />
