import svgPaths from "./svg-3pfjs0wpnn";
...
export default function CartAndOrdersDragonpayUi() {
  return (
    <div className="bg-white relative size-full" data-name="CART AND ORDERS_DRAGONPAY_UI">
      <Frame13 />
      <Frame25 />
      <Frame22 />
      <Frame3 />
