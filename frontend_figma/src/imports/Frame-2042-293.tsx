import svgPaths from "./svg-ehjou241ok";
...
function BubbleChat() {
  return (
    <div className="bg-[#000929] box-border content-stretch flex gap-[13.894px] items-start px-[13.894px] py-[9.263px] relative rounded-bl-[11.578px] rounded-br-[11.578px] rounded-tr-[11.578px] shadow-[0px_1.158px_3.473px_0px_rgba(237,98,20,0.1)] shrink-0 w-[314.926px]" data-name="bubble chat">
      <p className="font-['Comfortaa:Medium','Noto_Sans:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[16.209px] text-white tracking-[-0.3242px] w-[287.139px]">can it be something like this? brighter colors pls !! ( •̀ ω •́ )✧</p>
    </div>
  );
}
