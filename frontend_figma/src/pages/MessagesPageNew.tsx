...
import { ShoppingCart, CreditCard, MessageSquare, Bell, PlusSquare, Menu, MoreHorizontal } from 'lucide-react';
...
const mockConversations: Conversation[] = [
  ...
  // Service Tab Conversations - Commissions
  {
    ...
    messages: [
      { id: '1', text: 'Hi! I wanted to check on the progress of my commission (Order #1532425135231)', timestamp: 'Today 14:30', isSent: false },
      { id: '2', text: 'Hello! I\'m currently working on the sketch phase. I\'ll have some drafts ready by tomorrow', timestamp: 'Today 14:35', isSent: true },
      { id: '3', text: 'That sounds great! Do you need any additional reference images?', timestamp: 'Today 14:37', isSent: false },
      { id: '4', text: 'Actually yes! If you have more character poses, that would be helpful', timestamp: 'Today 14:40', isSent: true },
      { id: '5', text: 'Sure! I\'ll send them over in a bit', timestamp: 'Today 14:42', isSent: false },
      { id: '6', text: 'Perfect! Can\'t wait to see the final piece', timestamp: 'Today 14:45', isSent: false },
    ],
  },
  {
    ...
    orderType: 'commission',
    messages: [
      { id: '1', text: 'Hi! I received the draft and I love it!', timestamp: 'Today 12:15', isSent: false },
      { id: '2', text: 'Glad you like it! Any revisions you\'d like to make?', timestamp: 'Today 12:20', isSent: true },
      { id: '3', text: 'Could you make the background a bit brighter?', timestamp: 'Today 12:22', isSent: false },
      { id: '4', text: 'Of course! I\'ll adjust that and send you the updated version', timestamp: 'Today 12:25', isSent: true },
      { id: '5', text: 'Thank you! The artwork is amazing', timestamp: 'Today 12:30', isSent: false },
    ],
  },
  {
    ...
    orderType: 'commission',
    messages: [
      { id: '1', text: 'Quick question about the commission details', timestamp: 'Yesterday 16:45', isSent: false },
      { id: '2', text: 'Sure! What would you like to know?', timestamp: 'Yesterday 16:50', isSent: true },
      { id: '3', text: 'Can we adjust the deadline by a few days?', timestamp: 'Yesterday 16:52', isSent: false },
      { id: '4', text: 'Absolutely! I\'ll update the timeline for you', timestamp: 'Yesterday 16:55', isSent: true },
      { id: '5', text: 'Will do! Thanks for your patience', timestamp: 'Yesterday 17:00', isSent: false },
    ],
  },
  // Service Tab Conversations - Products
  {
    ...
    orderType: 'product',
    messages: [
      { id: '1', text: 'Hi! I wanted to inquire about my product order #1532425135231', timestamp: 'Today 13:20', isSent: false },
      { id: '2', text: 'Hello! Your order is currently being processed', timestamp: 'Today 13:25', isSent: true },
      { id: '3', text: 'When can I expect it to ship?', timestamp: 'Today 13:27', isSent: false },
      { id: '4', text: 'It should ship within 2-3 business days', timestamp: 'Today 13:30', isSent: true },
      { id: '5', text: 'Your order has been shipped!', timestamp: 'Today 15:00', isSent: true },
    ],
  },
  {
    userId: 'product-002',
    ...
    orderType: 'product',
    messages: [
      { id: '1', text: 'Hi! Can I change the shipping address for my order?', timestamp: 'Today 11:00', isSent: false },
      { id: '2', text: 'Sure! What\'s the new address?', timestamp: 'Today 11:05', isSent: true },
      { id: '3', text: '123 New Street, City, ZIP 12345', timestamp: 'Today 11:07', isSent: false },
      { id: '4', text: 'Updated! Your order will be sent to the new address', timestamp: 'Today 11:10', isSent: true },
      { id: '5', text: 'Thanks for your order! ✨', timestamp: 'Today 11:12', isSent: true },
    ],
  },
  {
    userId: 'product-003',
    ...
    orderType: 'product',
    messages: [
      { id: '1', text: 'Hi! Checking on the delivery status', timestamp: 'Yesterday 10:30', isSent: false },
      { id: '2', text: 'Your package is out for delivery!', timestamp: 'Yesterday 10:45', isSent: true },
      { id: '3', text: 'Great! What\'s the tracking number?', timestamp: 'Yesterday 10:47', isSent: false },
      { id: '4', text: 'TRK123456789 - you can track it on our website', timestamp: 'Yesterday 10:50', isSent: true },
      { id: '5', text: 'Package should arrive tomorrow!', timestamp: 'Yesterday 11:00', isSent: true },
    ],
  },
];
...
export default function MessagesPage() {
  ...
  const sidebarItems = [
    { icon: 'home', label: 'Home', active: false, onClick: () => navigate('/home') },
    { icon: ShoppingCart, label: 'Cart and Orders', active: false, onClick: () => navigate('/cart') },
    { icon: CreditCard, label: 'My Payments', active: false, onClick: () => navigate('/payments') },
    { icon: MessageSquare, label: 'Messages', active: true },
    { icon: Bell, label: 'Notifications', active: false, onClick: handleNotificationsClick },
    { icon: PlusSquare, label: 'Create', active: false, disabled: true },
  ...
  return (
    <div className="w-full h-screen bg-[#D1ECFF] flex overflow-hidden">
      {/* Left Sidebar */}
      <div 
        className={`fixed left-0 top-0 h-screen bg-white border-r border-[#e2e8f0] transition-all duration-300 ease-in-out z-40 flex flex-col ${
          isSidebarHovered && !isNotificationPanelOpen ? 'w-[250px]' : 'w-[90px]'
        }`}
        onMouseEnter={() => {
      ...
      >
        <div className="h-[100px] flex items-center border-b border-[#e2e8f0] px-5">
          {isSidebarHovered ? (
            <div className="flex items-center gap-4">
              ...
              <img src={imgLogoAlter2} alt="MERAKI" className={`h-[80px] w-auto transition-opacity duration-300 ${isNotificationPanelOpen ? 'opacity-0 invisible' : 'opacity-100'}`} />
            </div>
          ) : (
        ...
        <nav className="flex-1 py-8 px-4 space-y-2">
          {sidebarItems.map((item, index) => {
            ...
            const isActive = (isMessages && !isNotificationPanelOpen) || (isNotifications && isNotificationPanelOpen);
            
            return (
              <button
                key={index}
                onClick={item.onClick}
                className={`w-full flex items-center ${isSidebarHovered && !isNotificationPanelOpen ? 'gap-4 px-4' : 'justify-center px-0'} py-3 rounded-lg transition-colors ${
                  item.disabled 
        ...
        <div className="h-[88px] border-t border-[#e2e8f0] flex items-center justify-between px-4">
          <div className="flex items-center gap-3">
            <div className="w-[44px] h-[44px] rounded-full overflow-hidden flex-shrink-0 cursor-pointer" onClick={() => navigate('/profile/penguu')}>
